...
class ZerogpuApi:
    ...
    environment : ZerogpuApiEnvironment
        The environment to use for requests from the client. from .environment import ZerogpuApiEnvironment



        Defaults to ZerogpuApiEnvironment.PRODUCTION
    ...
    def __init__(
        ...
        *,
        ...
        environment: ZerogpuApiEnvironment = ZerogpuApiEnvironment.PRODUCTION,
        api_key: str,
