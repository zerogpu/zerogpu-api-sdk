...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::ZerogpuApi.Core.ApiResponse> SendRequestAsync(
        global::ZerogpuApi.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::ZerogpuApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::ZerogpuApi.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::ZerogpuApi.Core.BaseRequest request)
    {
