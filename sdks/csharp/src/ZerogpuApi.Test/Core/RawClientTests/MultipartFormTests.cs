...
namespace ZerogpuApi.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static ZerogpuApi.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new ZerogpuApi.Core.MultipartFormRequest
        {
