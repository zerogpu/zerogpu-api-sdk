...
func (r *RequestOptions) ToHeader() http.Header {
	...
	header.Set("x-project-id", fmt.Sprintf("%v", r.ProjectID))
	return header
}
...
// ProjectIDOption implements the RequestOption interface.
type ProjectIDOption struct {
	ProjectID string
}

func (p *ProjectIDOption) applyRequestOptions(opts *RequestOptions) {
