...
public final class RequestOptions {
  ...
  private RequestOptions(String apiKey, String projectId, Optional<Integer> timeout,
  ...
  public static class Builder {
    ...
    public RequestOptions build() {
      return new RequestOptions(apiKey, projectId, timeout, timeoutTimeUnit, headers, headerSuppliers, queryParameters, queryParameterSuppliers);
    }
  }
}
