...
require_relative "lib/zerogpu/version"
...
Gem::Specification.new do |spec|
  spec.name = "zerogpu"
  spec.authors = ["Zerogpu"]
  spec.version = Zerogpu::VERSION
  spec.summary = "Ruby client library for the Zerogpu API"
  spec.description = "The Zerogpu Ruby library provides convenient access to the Zerogpu API from Ruby."
