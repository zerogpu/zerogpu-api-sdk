...
describe Zerogpu::Internal::Types::Union do
  class Rectangle < Zerogpu::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Zerogpu::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Zerogpu::Internal::Types::Model
