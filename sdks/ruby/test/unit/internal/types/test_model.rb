...
describe Zerogpu::Internal::Types::Model do
  ...
  class ExampleModel < Zerogpu::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Zerogpu::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Zerogpu::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Zerogpu::Internal::Types::Model
