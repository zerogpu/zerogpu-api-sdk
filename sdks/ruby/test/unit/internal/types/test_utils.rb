...
describe Zerogpu::Internal::Types::Utils do
  Utils = Zerogpu::Internal::Types::Utils

  module TestUtils
    class M < Zerogpu::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Zerogpu::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Zerogpu::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend Zerogpu::Internal::Types::Union
    ...
    SymbolStringHash = Zerogpu::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Zerogpu::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Enum" do
      module ExampleEnum
        extend Zerogpu::Internal::Types::Enum
    ...
    describe "Array" do
      StringArray = Zerogpu::Internal::Types::Array[String]
      ModelArray = -> { Zerogpu::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Zerogpu::Internal::Types::Array[TestUtils::U] }
